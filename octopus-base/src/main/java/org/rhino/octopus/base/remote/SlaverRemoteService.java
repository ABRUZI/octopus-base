...
public class SlaverRemoteService {
	...
	public static class Client extends org.apache.thrift.TServiceClient
		...
		public void send_start(String flowId)
				throws org.apache.thrift.TException {
		...
		public void send_stop(String flowId)
				throws org.apache.thrift.TException {
	...
	public static class AsyncClient extends
		...
		public void start(String flowId,
				...
				throws org.apache.thrift.TException {
			checkReady();
			start_call method_call = new start_call(flowId, resultHandler,
					this, ___protocolFactory, ___transport);
			this.___currentMethod = method_call;
			___manager.call(method_call);
		}

		public static class start_call extends
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot)
				...
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage(
						"start", org.apache.thrift.protocol.TMessageType.CALL,
						0));
				start_args args = new start_args();
				args.setFlowId(flowId);
				args.write(prot);
		...
		public void stop(String flowId,
				...
				throws org.apache.thrift.TException {
			checkReady();
			stop_call method_call = new stop_call(flowId, resultHandler, this,
					___protocolFactory, ___transport);
			this.___currentMethod = method_call;
			___manager.call(method_call);
		}

		public static class stop_call extends
				org.apache.thrift.async.TAsyncMethodCall {
			private String flowId;
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot)
					throws org.apache.thrift.TException {
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage(
						"stop", org.apache.thrift.protocol.TMessageType.CALL, 0));
				stop_args args = new stop_args();
				args.setFlowId(flowId);
				args.write(prot);
				prot.writeMessageEnd();
	...
	public static class Processor<I extends Iface> extends
		...
		public static class start<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, start_args> {
			public start() {
				super("start");
			}
			...
			public start_result getResult(I iface, start_args args)
					throws org.apache.thrift.TException {
				start_result result = new start_result();
		...
		public static class stop<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, stop_args> {
			public stop() {
				super("stop");
			}
			...
			public stop_result getResult(I iface, stop_args args)
					throws org.apache.thrift.TException {
				stop_result result = new stop_result();
	...
	public static class AsyncProcessor<I extends AsyncIface> extends
		...
		public static class start<I extends AsyncIface> extends
				org.apache.thrift.AsyncProcessFunction<I, start_args, Void> {
			public start() {
				super("start");
			}
		...
		public static class stop<I extends AsyncIface> extends
				org.apache.thrift.AsyncProcessFunction<I, stop_args, Void> {
			public stop() {
				super("stop");
			}
	...
	public static class start_args implements
			org.apache.thrift.TBase<start_args, start_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<start_args> {
		...
		static {
			schemes.put(StandardScheme.class,
					new start_argsStandardSchemeFactory());
		...
		static {
			...
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					start_args.class, metaDataMap);
		}

		public start_args() {
		}

		public start_args(String flowId) {
			this();
			this.flowId = flowId;
		}
		...
		private static class start_argsStandardSchemeFactory implements
				SchemeFactory {
		...
		private static class start_argsStandardScheme extends
				StandardScheme<start_args> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					start_args struct) throws org.apache.thrift.TException {
		...
		private static class start_argsTupleSchemeFactory implements
				SchemeFactory {
		...
		private static class start_argsTupleScheme extends
				TupleScheme<start_args> {
	...
	public static class start_result implements
			org.apache.thrift.TBase<start_result, start_result._Fields>,
			java.io.Serializable, Cloneable, Comparable<start_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"start_result");
		...
		static {
			schemes.put(StandardScheme.class,
					new start_resultStandardSchemeFactory());
		...
		static {
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					start_result.class, metaDataMap);
		}
		...
		private static class start_resultStandardSchemeFactory implements
				SchemeFactory {
		...
		private static class start_resultStandardScheme extends
				StandardScheme<start_result> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					start_result struct) throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
					schemeField = iprot.readFieldBegin();
		...
		private static class start_resultTupleSchemeFactory implements
				SchemeFactory {
		...
		@SuppressWarnings("unused")
		private static class start_resultTupleScheme extends
				TupleScheme<start_result> {
	...
	public static class stop_args implements
			org.apache.thrift.TBase<stop_args, stop_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<stop_args> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"stop_args");
		...
		static {
			schemes.put(StandardScheme.class,
					new stop_argsStandardSchemeFactory());
		...
		static {
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					stop_args.class, metaDataMap);
		}

		public stop_args() {
		}

		public stop_args(String flowId) {
			this();
			this.flowId = flowId;
		}
		...
		private static class stop_argsStandardSchemeFactory implements
				SchemeFactory {
		...
		private static class stop_argsStandardScheme extends
				StandardScheme<stop_args> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					stop_args struct) throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
					schemeField = iprot.readFieldBegin();
		...
		private static class stop_argsTupleSchemeFactory implements
				SchemeFactory {
		...
		private static class stop_argsTupleScheme extends
				TupleScheme<stop_args> {
	...
	public static class stop_result implements
			org.apache.thrift.TBase<stop_result, stop_result._Fields>,
			java.io.Serializable, Cloneable, Comparable<stop_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"stop_result");
		...
		static {
			schemes.put(StandardScheme.class,
					new stop_resultStandardSchemeFactory());
		...
		private static class stop_resultStandardSchemeFactory implements
				SchemeFactory {
		...
		private static class stop_resultStandardScheme extends
				StandardScheme<stop_result> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					stop_result struct) throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
					schemeField = iprot.readFieldBegin();
		...
		private static class stop_resultTupleSchemeFactory implements
				SchemeFactory {
		...
		@SuppressWarnings("unused")
		private static class stop_resultTupleScheme extends
				TupleScheme<stop_result> {
